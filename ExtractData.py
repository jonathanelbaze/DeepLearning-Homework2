...
refs = pd.merge(trainPD, ref, how='left', left_on='id', right_on='id')
trainref = pd.merge(refs, text, how='left', left_on='id.1', right_on='id')
print(trainref)
trainref['text'] = trainref['text'] + ', ' + trainref['title']
print(trainref)
